define(["exports"], function(t) {
    ...
    class o {
        ...
        findMatchingRoute({
            ...
            for (const i of r) {
                ...
                if (o) return r = o, (Array.isArray(r) && 0 === r.length || o.constructor === Object && 0 === Object.keys(o).length || "boolean" == typeof o) && (r = void 0), {
                    route: i,
                    params: r
                }
            }
    ...
    class v {
        constructor(t, e) {
            this.h = {}, Object.assign(this, e), this.event = e.event, this.u = t, this.l = new y, this.p = [], this.m = [...t.plugins], this.R = new Map;
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: n,
                matchOptions: r
            } = this.u, i = await this.getCacheKey(e, "read"), o = Object.assign(Object.assign({}, r), {
                cacheName: n
            });
        ...
        async cachePut(t, e) {
            ...
            const {
                cacheName: a,
                matchOptions: c
            } = this.u, h = await self.caches.open(a), u = this.hasCallback("cacheDidUpdate"), l = u ? await async function(t, e, s, n) {
                const r = p(e.url, s);
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.h[s]) {
                let n = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = R(await t({
                    mode: e,
                    request: n,
                    event: this.event,
                    params: this.params
    ...
    class q {
        ...
        async q(t, e, n) {
            ...
            try {
                if (r = await this.L(e, t), !r || "error" === r.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
    ...
    class N extends q {
        constructor(t = {}) {
            t.cacheName = w(t.cacheName), super(t), this.C = !1 !== t.fallbackToNetwork, this.plugins.push(N.copyRedirectedCacheableResponsesPlugin)
        }
        async L(t, e) {
        ...
        P() {
            let t = null,
                e = 0;
            for (const [s, n] of this.plugins.entries()) n !== N.copyRedirectedCacheableResponsesPlugin && (n === N.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
            0 === e ? this.plugins.push(N.defaultPrecacheCacheabilityPlugin) : e > 1 && null !== t && this.plugins.splice(t, 1)
        }
    }
    ...
    class P {
        constructor({
            ...
            this.T = new Map, this.k = new Map, this.W = new Map, this.u = new N({
                cacheName: w(t),
                plugins: [...e, new E({
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {
                    cacheKey: t,
                    url: r
                } = L(n), i = "string" != typeof n && n.revision ? "reload" : "default";
                if (this.T.has(r) && this.T.get(r) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.T.get(r),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.W.has(t) && this.W.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {
                        url: r
                    });
    ...
    t.NetworkFirst = class extends q {
        constructor(t = {}) {
            super(t), this.plugins.some(t => "cacheWillUpdate" in t) || this.plugins.unshift(u), this.j = t.networkTimeoutSeconds || 0
        }
        async L(t, e) {
            const n = [],
                r = [];
            ...
            r.push(o);
            const a = await e.waitUntil((async () => await e.waitUntil(Promise.race(r)) || await o)());
            if (!a) throw new s("no-response", {
                url: t.url
            });
            return a
        }
        ...
        async L(t, e) {
            ...
            try {
                ...
                if (r = await Promise.race(s), !r) throw new Error(`Timed out the network response after ${this.j} seconds.`)
            } catch (t) {
                t instanceof Error && (n = t)
            }
...
//# sourceMappingURL=workbox-207e2d76.js.map