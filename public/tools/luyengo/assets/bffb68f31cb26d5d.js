...
(self.webpackChunkkeybr_com = self.webpackChunkkeybr_com || []).push([
    [4071], {
        4071(e, t, c) {
            ...
            var n = c(8892),
                l = c(2044);
            const i = ["Backquote", "Digit1", "Digit2", "Digit3", "Digit4", "Digit5", "Digit6", "Digit7", "Digit8", "Digit9", "Digit0", "Minus", "Equal", "IntlYen", "KeyQ", "KeyW", "KeyE", "KeyR", "KeyT", "KeyY", "KeyU", "KeyI", "KeyO", "KeyP", "BracketLeft", "BracketRight", "Backslash", "KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyH", "KeyJ", "KeyK", "KeyL", "Semicolon", "Quote", "IntlBackslash", "KeyZ", "KeyX", "KeyC", "KeyV", "KeyB", "KeyN", "KeyM", "Comma", "Period", "Slash", "IntlRo", "Space", "Tab", "CapsLock", "ThumbClusterLeft1", "ThumbClusterLeft2", "ThumbClusterRight1", "ThumbClusterRight2"],
                r = new Map([
                    [96, 768],
                    [180, 769],
                    [94, 770],
                ...
                f = (e, t, c) => {
                    ...
                    return null != s ? {
                        dead: s
                    } : (e.warnings.push(`[${t}] Invalid dead character: ${(0,l.B$)(c)}`), null)
                },
                h = ({
                    dead: e
                }) => {
                    if (42 === e) return "**";
                    const t = o.get(e);
                    return null != t ? String.fromCodePoint(42, t) : e
                };
            class u {
                static isKey(e) {
                    return i.includes(e)
                ...
                static from(e) {
                    const t = new u;
                    for (const [c, [s = null, a = null, n = null, l = null]] of Object.entries(e)) t.setAll(c, s, a, n, l);
                    return t
                }
#e = new Map;
                constructor(e = null) {
                    if (null != e)
                        for (const t of e) this.set(t)
                }*[Symbol.iterator]() {
                    for (const e of i) {
                        const t = this.#e.get(e);
                        null != t && t.valid && (yield t)
                    }
                }
                get size() {
                    return this.#e.size
                ...
                get(e) {
                    if (!u.isKey(e)) throw new TypeError(e);
                ...
                set(e) {
                    ...
                    if (!u.isKey(t)) throw new TypeError(t);
                ...
                setOne(e, t, c) {
                    ...
                    switch (t) {
                        case n.f7.None:
                            this.set(new n.i8(e, d(c), a, l, i));
                            break;
                        case n.f7.Shift:
                            this.set(new n.i8(e, s, d(c), l, i));
                            break;
                        case n.f7.Alt:
                            this.set(new n.i8(e, s, a, d(c), i));
                            break;
                        case n.f7.ShiftAlt:
                            this.set(new n.i8(e, s, a, l, d(c)))
                    }
                    return this
                }
                setAll(e, t, c, s, a) {
                    return this.setOne(e, n.f7.None, t), this.setOne(e, n.f7.Shift, c), this.setOne(e, n.f7.Alt, s), this.setOne(e, n.f7.ShiftAlt, a), this
                }
                dict() {
                    const e = {};
                    for (const {
                ...
                toJSON() {
                    ...
                    for (const {
                        ...
                        const i = [c, s, a, l];
                        for (; i.length > 0 && null == i.at(-1);) i.pop();
                        i.every(e => n.i8.isCodePoint(e)) ? e[t] = String.fromCodePoint(...i) : e[t] = i.map(e => n.i8.isCodePoint(e) ? String.fromCodePoint(e) : n.i8.isDead(e) ? h(e) : n.i8.isSpecial(e) ? e.special : e)
                    }
                    return e
                }
            }
            ...
            function m(e) {
                ...
                for (const [c, s] of Object.entries(JSON.parse(e))) u.isKey(c) ? x(t, c, s) : t.warnings.push(`Unknown key: ${c}`);
                return t
            }
            ...
            function x(e, t, c) {
                ...
                if ("string" == typeof c && (c = [...(0, l.ex)(c)]), Array.isArray(c)) {
                    const [e = null, a = null, l = null, r = null] = c;
                    s.setOne(t, n.f7.None, i(e)), s.setOne(t, n.f7.Shift, i(a)), s.setOne(t, n.f7.Alt, i(l)), s.setOne(t, n.f7.ShiftAlt, i(r))
                } else a.push(`[${t}] Invalid character list: ${c}`);

                function i(c) {
                    if (c) {
                        if (n.i8.isCodePoint(c) || n.i8.isDead(c) || n.i8.isSpecial(c) || n.i8.isLigature(c)) return c;
                        if ("string" == typeof c) {
                            const s = [...(0, l.ex)(c)];
                            if (0 === s.length) return null;
                            if (1 === s.length) return s[0];
                            if (2 === s.length && 42 === s[0]) return f(e, t, s[1])
                        }
                        a.push(`[${t}] Invalid character: ${c}`)
                    }
                    return null
                }
            }
                ...
                return function(e, t) {
                    ...
                    for (const s of e.split("\n")) {
                        ...
                        if (e) {
                            ...
                            if (/^COPYRIGHT\s+/.test(e) || /^COMPANY\s+/.test(e) || /^LOCALEID\s+/.test(e) || /^LOCALENAME\s+/.test(e) || /^VERSION\s+/.test(e)) continue;
                            if (/^ATTRIBUTES/.test(e)) {
                                c = p.ATTRIBUTES;
                                continue
                            }
                            if (/^SHIFTSTATE/.test(e)) {
                                c = p.SHIFTSTATE;
                                continue
                            }
                            if (/^LAYOUT/.test(e)) {
                            ...
                            if (/^KEYNAME_EXT/.test(e)) {
                                c = p.KEYNAME_EXT;
                                continue
                            }
                            if (/^KEYNAME_DEAD/.test(e)) {
                                c = p.KEYNAME_DEAD;
                                continue
                            }
                            if (/^DESCRIPTIONS/.test(e)) {
                                c = p.DESCRIPTIONS;
                                continue
                            }
                            if (/^LANGUAGENAMES/.test(e)) {
                                c = p.LANGUAGENAMES;
                                continue
                            }
                            if (/^ENDKBD/.test(e)) {
            ...
            function g(e, t) {
                e.shiftstate.push(Number(t))
            }

            function z(e, t) {
                const [c, s, a, ...n] = t.split(/\s+/), l = w[c];
                if (null != l) {
                    const t = [...n.map(t => function(e, t, c) {
                        if ("-1" === c || "%%" === c) return null;
                        if (1 === c.length) return c.codePointAt(0);
                        let s;
                        if (null != (s = /^([0-9a-f]{4})$/.exec(c))) return Number.parseInt(s[1], 16);
                        if (null != (s = /^([0-9a-f]{4})@$/.exec(c))) return f(e.result, t, Number.parseInt(s[1], 16));
                        return e.result.warnings.push(`[${t}] Invalid code point: ${c}`), null
                    }(e, l, t))];
                    for (let c = 0; c < t.length; c++) {
                        const s = A(e.shiftstate[c]),
                            a = t[c];
                        null != s && e.result.layout.setOne(l, s, a)
                    }
                    null != e.SC_to_VK[c] && e.result.warnings.push(`[${l}] Duplicate SC: ${c}`), null != e.VK_to_SC[s] && e.result.warnings.push(`[${l}] Duplicate VK: ${s}`), e.SC_to_VK[c] = s, e.VK_to_SC[s] = c
                }
            }

            function K(e, t) {
                const [c, s, ...a] = t.split(/\s+/), n = e.VK_to_SC[c], l = w[n];
                if (null != l) {
                    const t = String.fromCodePoint(...a.map(e => Number.parseInt(e, 16))),
                        c = A(e.shiftstate[Number(s)]);
                    null != c && e.result.layout.setOne(l, c, {
                        ligature: t
                    })
                }
            }
                ...
                for (let c = 0; c < e.length; c++) {
                    ...
                    switch (t) {
                        case !1:
                            ...
                            if (";" === s) return e.substring(0, c);
                            if ("/" === s && "/" === e.charAt(c + 1)) return e.substring(0, c);
                            break;
                        case !0:
                            if ('"' === s) {
                                t = !1;
            ...
            function A(e) {
                switch (e) {
                    ...
                    case 6:
                        return n.f7.Alt;
                    case 7:
                        return n.f7.ShiftAlt
                }
                return null
            }! function(e) {
                e[e.INIT = 0] = "INIT", e[e.KBD = 1] = "KBD", e[e.ATTRIBUTES = 2] = "ATTRIBUTES", e[e.SHIFTSTATE = 3] = "SHIFTSTATE", e[e.LAYOUT = 4] = "LAYOUT", e[e.LIGATURE = 5] = "LIGATURE", e[e.DEADKEY = 6] = "DEADKEY", e[e.KEYNAME = 7] = "KEYNAME", e[e.KEYNAME_EXT = 8] = "KEYNAME_EXT", e[e.KEYNAME_DEAD = 9] = "KEYNAME_DEAD", e[e.DESCRIPTIONS = 10] = "DESCRIPTIONS", e[e.LANGUAGENAMES = 11] = "LANGUAGENAMES", e[e.ENDKBD = 12] = "ENDKBD"
            }(p || (p = {}));
            const w = {
                "02": "Digit1",
                "03": "Digit2",
            ...
            async function E(e) {
                e instanceof Blob && (e = await e.bytes());
                const t = function(e) {
                    return new TextDecoder(function(e) {
                        return e.length >= 2 && 254 == (255 & e[0]) && !(255 & ~e[1]) ? "utf-16be" : e.length >= 2 && !(255 & ~e[0]) && 254 == (255 & e[1]) ? "utf-16le" : e.length >= 6 && 0 === e[0] && 0 !== e[1] && 0 === e[2] && 0 !== e[3] && 0 === e[4] && 0 !== e[5] ? "utf-16be" : e.length >= 6 && 0 !== e[0] && 0 === e[1] && 0 !== e[2] && 0 === e[3] && 0 !== e[4] && 0 === e[5] ? "utf-16le" : "utf-8"
                    }(e)).decode(e)
                }(e);
                for (const e of [a, m, j]) try {
                    const c = e(t);
                    if (c.layout.size > 0) return c
                } catch {}
                return null
            }
            var b = c(6450),
                ...
                T = c(6050),
                v = c(7810);
            const k = (0, v.createContext)(null);

            function C() {
                const e = (0, v.useContext)(k);
            ...
            function I({
                ...
                const [c, a] = (0, v.useState)(() => $(new u)), [l, i] = (0, v.useState)(() => (0, n.yu)(t));
                return (0, v.useEffect)(() => {
                    const {
                        geometry: e,
                        geometryDict: s
                    } = (0, n.yu)(t);
                    i(new n.s3(n.PE.custom(t.language), e, c.dict(), s))
                }, [t, c]), (0, s.jsx)(k.Provider, {
                    value: {
                        keyboard: l,
                        layout: c,
                        setLayout: e => {
            ...
            function $(e) {
                return e.setOne("Space", n.f7.None, 32)
            }
            var M = c(8346),
                O = c(4164),
                P = "uJ0RmVgUF2",
                ...
                X = c(9916);
            const J = 40,
                Z = e => new V.b(e.x * J + 38 * e.w / 2, e.y * J + 38 * e.h / 2),
                q = e => {
                    let t = 0,
                        c = 0;
                    for (const s of e.shapes.values()) t = Math.max(t, s.x + s.w), c = Math.max(c, s.y + s.h);
                    return new X.o(30 + t * J - 2, 30 + c * J - 2)
                },
                Q = ({
                    children: e,
                    ref: t,
            ...
            function ee({
                ...
                const {
                    ...
                    c: h,
                    d: u
                } = t, d = t.x * J, m = t.y * J, x = t.w * J - 2, j = t.h * J - 2, p = [];
                p.push(t.shape ? (0, s.jsx)("path", {
                    className: P,
                    d: t.shape
                }) : (0, s.jsx)("rect", {
                    className: P,
                    ...
                    width: x,
                    height: j
                })), t.homing && p.push((0, s.jsx)("circle", {
                    className: "jRTd41lToD",
                    cx: x / 2,
                    cy: j - 5,
                    r: 3
                }));
                for (const e of t.labels) p.push(te(e));
                const y = c(o),
                    g = c(f),
                    z = c(h),
                    K = c(u),
                    S = y && g && e(o) === e(f),
                    A = z && K && e(h) === e(u);
                y && !S && p.push(b(o, 10, 27, H)), g && !S && p.push(b(f, 10, 12, H)), z && !A && p.push(b(h, 25, 27, H)), K && !A && p.push(b(u, 25, 12, H)), y && S && p.push(b(o, 10, 12, F)), z && A && p.push(b(h, 25, 27, F)), a(o) && p.push(N(o, 10, 27, H)), a(f) && p.push(N(f, 10, 12, H)), a(h) && p.push(N(h, 25, 27, H)), a(u) && p.push(N(u, 25, 12, H)), i(o) && p.push(D(o, 10, 27, H)), i(f) && p.push(D(f, 10, 12, H)), i(h) && p.push(D(h, 25, 27, H)), i(u) && p.push(D(u, 25, 12, H));
                const w = function(e) {
                    return (0, O.$)(function({
                        hand: e
                    }) {
                ...
                function E({
                    ...
                    return (0, s.jsxs)("svg", { ...a,
                        className: (0, O.$)("o1IrlVFfzL", e && "HciBWswhaE", t && "vwNkZdLHdK", c && w),
                        x: d,
                        y: m,
                        width: x,
                        height: j,
                ...
                return E.displayName = `Key[${r}]`, (0, v.memo)(E);
                ...
                function N({
                    ...
                    return te({
                        text: (0, l.Z6)(e) ? String.fromCodePoint(9676, e) : String.fromCodePoint(e),
                        pos: [t, c],
                        align: ["m", "m"]
                    }, (0, O.$)(s, "zqzHfHFf8q"))
                }
            ...
            const ce = (0, v.memo)(function({
                ...
                const r = (0, n.de)(),
                    o = (0, v.useRef)(null),
                    f = (0, v.useMemo)(() => function(e) {
                        return [...e.shapes.values()].map(t => new ae(e, t))
                    }(r), [r]);
                return (0, s.jsx)(Q, {
                    ref: o,
                    onMouseOver: e => {
                    ...
                    children: f.map(s => s.select(e, t, c))
                })
            });
            ...
            function se(e, {
                ...
                for (; null != c && t instanceof Element && e.contains(t);) {
                    const e = t.dataset.key;
                    if (e) return void c(e, t);
                    t = t.parentElement
                }
            }
            class ae {
                ...
                state7;
                constructor(e, t) {
                    this.keyboard = e, this.shape = t;
                    const c = ee(e.layout.language, t);
                    this.component = c, this.state0 = (0, s.jsx)(c, {
                        depressed: !1,
                        toggled: !1,
                        showColors: !1
                    }, t.id), this.state1 = (0, s.jsx)(c, {
                        depressed: !0,
                        toggled: !1,
                        showColors: !1
                    }, t.id), this.state2 = (0, s.jsx)(c, {
                        depressed: !1,
                        toggled: !0,
                        showColors: !1
                    }, t.id), this.state3 = (0, s.jsx)(c, {
                        depressed: !0,
                        toggled: !0,
                        showColors: !1
                    }, t.id), this.state4 = (0, s.jsx)(c, {
                        depressed: !1,
                        toggled: !1,
                        showColors: !0
                    }, t.id), this.state5 = (0, s.jsx)(c, {
                        depressed: !0,
                        toggled: !1,
                        showColors: !0
                    }, t.id), this.state6 = (0, s.jsx)(c, {
                        depressed: !1,
                        toggled: !0,
                        showColors: !0
                    }, t.id), this.state7 = (0, s.jsx)(c, {
                        depressed: !0,
                        toggled: !0,
                        showColors: !0
                    }, t.id)
                ...
                select(e, t, c) {
                    const {
                        shape: s
                    } = this, a = e.includes(s.id), n = t.includes(s.id);
                    return c ? n ? a ? this.state7 : this.state6 : a ? this.state5 : this.state4 : n ? a ? this.state3 : this.state2 : a ? this.state1 : this.state0
                }
            }
            const ne = (0, v.memo)(function({
                children: e,
                keyboard: t,
                width: c,
                height: a,
                ...
                const r = q(t);
                return (0, s.jsxs)("svg", { ...i,
                    className: "DUsJFvE_k9",
                ...
                if (e) {
                    if (n.i8.isCodePoint(e)) {
                        ...
                        switch (e) {
                            ...
                            default:
                                t = (0, s.jsx)("span", {
                                    className: ie,
                                    children: String.fromCodePoint(e)
                                })
                        }
                    ...
                    if (n.i8.isDead(e)) {
                        const {
                            ...
                            className: (0, O.$)(ie, "rIEHVrjd7K"),
                            children: (0, l.Z6)(t) ? String.fromCodePoint(9676, t) : String.fromCodePoint(t)
                        });
                        return (0, s.jsxs)(s.Fragment, {
                            children: [c, " ", (0, l.B$)(t)]
                        })
                    }
                    if (n.i8.isLigature(e)) return (0, s.jsx)("span", {
                        className: (0, O.$)(ie, "Kzuw1XTVkP"),
                        children: e.ligature
                    });
                    if (n.i8.isSpecial(e)) return (0, l.B$)(e.special)
                }
                return (0, s.jsx)("span", {
                    className: "X8cqw1MuZQ",
                    children: "Unassigned"
                })
            }
            ...
            function ue() {
                ...
                return (0, s.jsx)(he.A, {
                    type: "textarea",
                    value: JSON.stringify(e.toJSON(), null, 2),
                    readOnly: !0,
                    rows: 20
                })
            }
            ...
            function je() {
                ...
                return (0, s.jsx)("div", {
                    className: "YR27a91aXW",
                    children: (0, s.jsxs)("table", {
                        className: "XgJqhvixut",
                        children: [(0, s.jsx)("thead", {
                            ...
                            children: u.allKeys().map(t => {
                                const {
                                    a: c,
                                    b: a,
                                    c: l,
                                    d: i
                                } = e.get(t) ?? new n.i8(t, null, null, null, null);
                                return (0, s.jsxs)("tr", {
                                    className: xe,
                                    children: [(0, s.jsx)("td", {
                                        className: me,
            ...
            function pe({
                ...
                const {
                    keyboard: c,
                    layout: a
                } = C(), [l, i] = (0, v.useState)(0);
                return (0, s.jsxs)(M.w, {
                    selectedIndex: l,
                    onSelect: i,
                    children: [(0, s.jsxs)(M.o, {
                        label: "Keyboard",
                        children: [(0, s.jsx)(ne, {
                            keyboard: c,
                            children: (0, s.jsx)(ce, {
                            ...
                            characters: a.get(e) ?? new n.i8(e, 0, 0, 0, 0)
                        })]
                    }), (0, s.jsx)(M.o, {
                        label: "Table",
                        children: (0, s.jsx)(je, {})
            ...
            function ge({
                ...
                const {
                    layout: t,
                    setLayout: c
                } = C(), [a, l] = (0, v.useState)(null), i = (0, v.useRef)(null);
                return (0, s.jsxs)(D.d, {
                    children: [(0, s.jsx)(D.D, {
                        children: "Live import:"
                    }), (0, s.jsx)(D.D, {
                        children: (0, s.jsx)(he.A, {
                            size: 6,
                            value: String.fromCodePoint(a ?.codePoint ?? 32),
                            onKeyDown: e => {
                                const {
                                    code: t
                                } = e;
                                if ("Tab" === t && e.preventDefault(), u.isKey(t)) {
                                    const c = e.getModifierState("Shift"),
                                        s = e.getModifierState("Alt") || e.getModifierState("AltGraph");
                                    i.current = {
                                        code: t,
                                        shift: c,
                                        alt: s
                            ...
                            onInput: s => {
                                const a = i.current;
                                if (null != a && "insertText" === s.inputType && s.data) {
                                    const {
                                        code: i,
                                        shift: r,
                                        alt: o
                                    } = a, f = n.f7.from(r, o), h = s.data.codePointAt(0) ?? 0;
                                    c(t.setOne(i, f, h)), l({
                                        key: i,
                                        codePoint: h,
                                        modifier: f
                ...
                return (0, s.jsxs)("section", {
                    children: [(0, s.jsx)("a", {
                        ...
                        onChange: () => {
                            const e = t.current,
                                c = e.files;
                            null != c && c.length > 0 && E(c[0]).then(e => {
                                if (null == e) b.$.report("Invalid layout file");
                                else {
                                    const {
                                        layout: t,
                                        warnings: c
                                    } = e;
                                    a(t), c.length > 0 && b.$.report(new AggregateError(c))
                                }
                            }).catch(e => {
                                console.error(e)
                            }).finally(() => {
                        ...
                        align: "center",
                        children: "This is a preview of the feature that is still a work in progress."
                    }), (0, s.jsx)(pe, {
                        keyId: n,
                        setKeyId: l
                    }), (0, s.jsx)(ge, {
                        ...
                        children: [(0, s.jsx)(D.D, {
                            children: (0, s.jsx)(T.$, {
                                ...
                                onClick: () => {
                                    (async function(e) {
                                        const t = JSON.stringify(e.toJSON(), null, 2);
                                        return new Blob([t], {
                                            type: "application/json"
                                        })
                                    })(c).then(t => {
                                        const c = e.current;
                                        c.setAttribute("href", URL.createObjectURL(t)), c.click()
                                    }).catch(e => {
                                        console.error(e)
                                    })
                                }
                        ...
                        }), (0, s.jsx)(D.D.Filler, {}), (0, s.jsx)(D.D, {
                            children: (0, s.jsx)(T.$, {
                                label: "Reset",
                                onClick: () => {
                                    a(new u)
            ...
            const Ae = (0, v.memo)(function({
                ...
                return (0, s.jsx)(Q, {
                    children: function() {
                        ...
                        for (const [c, s] of e)
                            if (s > 0) {
                                const e = a(c);
                                null != e && t.set(e, (t.get(e) ?? 0) + s)
                            }
                        return function(e) {
                            const t = e.map(e => e[1]),
                                c = Math.min(...t),
                                s = Math.max(...t);
                            return e.map(([e, t]) => [e, s > c ? (t - c) / (s - c) : .5]).sort((e, t) => e[1] - t[1])
                        }([...t])
                    }().map(function([e, c], a) {
                        const {
                            x: n,
                            ...
                            case "h":
                                {
                                    const e = 15 * c + 5;
                                    return (0, s.jsx)("path", {
                                        className: (0, O.$)(Se, "TcUZeAuP2a"),
                                        d: `M ${n-e} ${l+e} A${e} ${e} 0 0 1 ${n+e} ${l-e}`
                                    }, a)
                                }
                            case "m":
                                {
                                    const e = 15 * c + 5;
                                    return (0, s.jsx)("path", {
                                        className: (0, O.$)(Se, "T3UBpt2hcU"),
                                        d: `M ${n-e} ${l+e} A ${e} ${e} 0 0 0 ${n+e} ${l-e}`
                                    }, a)
                                }
                            case "f":
                                {
                ...
                function a(e) {
                    if (32 !== e) {
                        const t = c.getCombo(e);
                        if (null != t) {
                            const e = c.getShape(t.id);
                            if (null != e) return e
                        }
                    }
                    return null
            ...
            var Te = c(8767),
                ve = "fK4ZHznyZO";
            const ke = (0, v.memo)(function({
                suffix: e,
                delay: t = 1e3
            }) {
                const c = (0, n.de)(),
                    a = (0, v.useRef)(null),
                    [l, i] = (0, v.useState)(null);
                return (0, v.useEffect)(() => {
                    const s = new Te.ZU;
                    if (i(null), e.length > 0) {
                        const a = c.getCombo(e[0]);
                        null != a && s.delayed(t, () => {
                            i(a)
                        })
                    }
                    ...
                    const e = a.current;
                    if (null != e)
                        for (const t of e.querySelectorAll("animate")) t.beginElement()
                }, [l]), (0, s.jsxs)(Q, {
                    ref: a,
                    children: [...Ce(c, l)]
                })
            ...
            function Ce(e, t) {
                const c = [];
                for (; null != t;) {
                    const s = e.getShape(t.id);
                    if (null != s) {
                        if (c.unshift(Ie(s, "FDeAcT5ajB")), t.modifier.shift) {
                            const t = e.getShape("ShiftLeft"),
                                a = e.getShape("ShiftRight");
                            switch (s.hand) {
                                case "left":
                                    c.unshift(Ie(a, ve));
                                    break;
                                case "right":
                                    ...
                                    break;
                                default:
                                    c.unshift(Ie(t, ve), Ie(a, ve))
                            }
                        }
                        if (t.modifier.alt) {
                            const t = e.getShape("AltLeft"),
                                a = e.getShape("AltRight");
                            switch (s.hand) {
                                case "left":
                                    c.unshift(Ie(a, ve));
                                    break;
            ...
            const Me = (0, v.memo)(function({
                ...
                return (0, s.jsxs)(Q, {
                    children: [(0, s.jsx)("defs", {
                        ...
                        const t = [];
                        for (const [c, s, n] of [...e].sort((e, t) => t[2] - e[2]).slice(0, 100))
                            if (n > 0) {
                                const e = a(c),
                                    l = a(s);
                                null != e && null != l && t.push([e, l, n])
                            }
                        return function(e) {
                            const t = e.map(e => e[2]),
                                c = Math.min(...t),
                                s = Math.max(...t);
                            return e.map(([e, t, a]) => [e, t, s > c ? (a - c) / (s - c) : .5]).sort((e, t) => e[2] - t[2])
                        }(t)
                    }().map(function([e, c, a], n) {
                        if (e === c) return null;
                        const {
                            x: l,
                            y: i
                            ...
                            x: r,
                            y: o
                        } = Z(c), f = r - l, h = o - i, u = Math.atan2(h, f), d = Math.sqrt(f * f + h * h), m = l + (r - l) / 2 + (o - i) / d * d / 4, x = i + (o - i) / 2 + -(r - l) / d * d / 4, j = l + 3 * Math.cos(u), p = i + 3 * Math.sin(u), y = r - 3 * Math.cos(u), g = o - 3 * Math.sin(u);
                        return (0, s.jsx)("path", {
                            className: (0, O.$)("krdmM6BvsG", Oe(t)),
                            d: `M ${j} ${p} Q ${m} ${x} ${y} ${g}`,
                            opacity: .9 * a + .1,
                            markerEnd: `url(#${$e})`
                        }, n)
            ...
            const Pe = (0, v.memo)(function() {
                    const e = (0, n.de)(),
                        t = t => {
                            for (const c of e.shapes.values())
                                if (c.homing && c.inZone(t)) return c;
                            return null
                        },
                        c = t("left") ?? e.getShape("KeyF"),
                        a = t("right") ?? e.getShape("KeyJ");
                    return null != c && null != a ? (0, s.jsxs)(Q, {
                        children: [(0, s.jsx)(Be, {
                            center: Z(c)
                        }), (0, s.jsx)(Re, {
                            center: Z(a)
...
//# sourceMappingURL=bffb68f31cb26d5d.js.map