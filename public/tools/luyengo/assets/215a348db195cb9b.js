...
#t;
                constructor(e = 64) {
                    this.#e = new DataView(new ArrayBuffer(Math.max(e, 64))), this.#t = 0
                }
#s(e) {
                    if (this.#e.byteLength < e) {
                        let t = 64;
                        for (; t < e;) t *= t;
                        const s = new ArrayBuffer(t);
                        new Uint8Array(s).set(new Uint8Array(this.#e.buffer)), this.#e = new DataView(s)
                    }
                }
#n(e) {
                    this.#s(this.#t + e)
                ...
                putInt8(e) {
                    if (!Number.isInteger(e) || e < -128 || e > 127) throw new TypeError("Value is not int8");
                    return this.#n(1), this.#e.setInt8(this.#t, e), this.#t += 1, this
                }
                putUint8(e) {
                    if (!Number.isInteger(e) || e < 0 || e > 255) throw new TypeError("Value is not uint8");
                    return this.#n(1), this.#e.setUint8(this.#t, e), this.#t += 1, this
                }
                putInt16(e) {
                    if (!Number.isInteger(e) || e < -32768 || e > 32767) throw new TypeError("Value is not int16");
                    return this.#n(2), this.#e.setInt16(this.#t, e, !1), this.#t += 2, this
                }
                putUint16(e) {
                    if (!Number.isInteger(e) || e < 0 || e > 65535) throw new TypeError("Value is not uint16");
                    return this.#n(2), this.#e.setUint16(this.#t, e, !1), this.#t += 2, this
                }
                putInt32(e) {
                    if (!Number.isInteger(e) || e < -2147483648 || e > 2147483647) throw new TypeError("Value is not int32");
                    return this.#n(4), this.#e.setInt32(this.#t, e, !1), this.#t += 4, this
                }
                putUint32(e) {
                    if (!Number.isInteger(e) || e < 0 || e > 4294967295) throw new TypeError("Value is not uint32");
                    return this.#n(4), this.#e.setUint32(this.#t, e, !1), this.#t += 4, this
                }
                putFloat32(e) {
                    return this.#n(4), this.#e.setFloat32(this.#t, e, !1), this.#t += 4, this
                }
                putFloat64(e) {
                    return this.#n(8), this.#e.setFloat64(this.#t, e, !1), this.#t += 8, this
                }
                putIntVlq(e) {
                    if (!Number.isInteger(e) || e < -2147483648 || e > 2147483647) throw new TypeError("Value is not int32");
                    return this.putUintVlq((e << 1 ^ e >> 31) >>> 0), this
                }
                putUintVlq(e) {
                    if (!Number.isInteger(e) || e < 0 || e > 4294967295) throw new TypeError("Value is not uint32");
...
#a(e) {
                    e > 266338304 && this.putUint8(e >>> 28 & 15 | 128), e > 2080768 && this.putUint8(e >>> 21 & 127 | 128), e > 16256 && this.putUint8(e >>> 14 & 127 | 128), e > 127 && this.putUint8(e >>> 7 & 127 | 128), this.putUint8(127 & e)
                }
                putString(e) {
                    const t = function(e) {
                        let t = 0,
                            s = 0;
                        for (; s < e.length;) {
                            const n = e.codePointAt(s) ?? 0;
                            n <= 127 ? (t += 1, s += 1) : n <= 2047 ? (t += 2, s += 1) : n <= 65535 ? (t += 3, s += 1) : n <= 1114111 && (t += 4, s += 2)
                        }
                        return t
                    }(e);
                    return this.putUintVlq(t), this.#n(t),
                        function(e, t, s) {
                            let n = 0;
                            for (; n < e.length;) {
                                const a = e.codePointAt(n) ?? 0;
                                a <= 127 ? (t.setUint8(s++, a), n += 1) : a <= 2047 ? (t.setUint8(s++, a >> 6 & 31 | 192), t.setUint8(s++, 63 & a | 128), n += 1) : a <= 65535 ? (t.setUint8(s++, a >> 12 & 15 | 224), t.setUint8(s++, a >> 6 & 63 | 128), t.setUint8(s++, 63 & a | 128), n += 1) : a <= 1114111 && (t.setUint8(s++, a >> 18 & 127 | 240), t.setUint8(s++, a >> 12 & 63 | 128), t.setUint8(s++, a >> 6 & 63 | 128), t.setUint8(s++, 63 & a | 128), n += 2)
                            }
                        }(e, this.#e, this.#t), this.#t += t, this
                }
                putBuffer(e) {
                    return this.#n(e.byteLength), new Uint8Array(this.#e.buffer).set(e, this.#t), this.#t += e.byteLength, this
                }
                buffer() {
                    return new Uint8Array(this.#e.buffer, 0, this.#t)
                }
            }
            class i {
#e;
#t = 0;
                constructor(e) {
                    ArrayBuffer.isView(e) ? this.#e = new DataView(e.buffer, e.byteOffset, e.byteLength) : this.#e = new DataView(e)
                }
#n(e) {
                    if (this.#t + e > this.#e.byteLength) throw new n("Premature end of data")
                }
                getInt8() {
                    this.#n(1);
                    const e = this.#e.getInt8(this.#t);
                    return this.#t += 1, e
                }
                getUint8() {
                    this.#n(1);
                    const e = this.#e.getUint8(this.#t);
                    return this.#t += 1, e
                }
                getInt16() {
                    this.#n(2);
                    const e = this.#e.getInt16(this.#t, !1);
                    return this.#t += 2, e
                }
                getUint16() {
                    this.#n(2);
                    const e = this.#e.getUint16(this.#t, !1);
                    return this.#t += 2, e
                }
                getInt32() {
                    this.#n(4);
                    const e = this.#e.getInt32(this.#t, !1);
                    return this.#t += 4, e
                }
                getUint32() {
                    this.#n(4);
                    const e = this.#e.getUint32(this.#t, !1);
                    return this.#t += 4, e
                }
                getFloat32() {
                    this.#n(4);
                    const e = this.#e.getFloat32(this.#t, !1);
                    return this.#t += 4, e
                }
                getFloat64() {
                    this.#n(8);
                    const e = this.#e.getFloat64(this.#t, !1);
                    return this.#t += 8, e
                }
                getIntVlq() {
                    const e = this.getUintVlq();
                    return e >>> 1 ^ -(1 & e)
                }
                getUintVlq() {
                    return this.#i()
...
#i() {
                    let e = 0;
                    const t = this.getUint8();
                    if (e = (e << 7 | 127 & t) >>> 0, !(128 & t)) return e;
                    const s = this.getUint8();
                    if (e = (e << 7 | 127 & s) >>> 0, !(128 & s)) return e;
                    const a = this.getUint8();
                    if (e = (e << 7 | 127 & a) >>> 0, !(128 & a)) return e;
                    const i = this.getUint8();
                    if (e = (e << 7 | 127 & i) >>> 0, !(128 & i)) return e;
                    const r = this.getUint8();
                    if (e = (e << 7 | 127 & r) >>> 0, !(128 & r)) {
                        if ((127 & t) > 15) throw new n("Too many leading bits");
                        return e
                    }
                    throw new n("Too many trailing bits")
                }
                getString() {
                    const e = this.getUintVlq();
                    this.#n(e);
                    const t = function(e, t, s) {
                        ...
                        for (; t < i;) {
                            ...
                            if (s < 128) a += String.fromCodePoint(s);
                            else if (192 == (224 & s)) {
                                if (t + 1 > i) throw new n("Truncated UTF-8 stream");
                                const r = (31 & s) << 6 | 63 & e.getUint8(t++);
                                a += String.fromCodePoint(r)
                            } else if (224 == (240 & s)) {
                                if (t + 2 > i) throw new n("Truncated UTF-8 stream");
                                const r = (15 & s) << 12 | (63 & e.getUint8(t++)) << 6 | 63 & e.getUint8(t++);
                                a += String.fromCodePoint(r)
                            } else {
                                if (240 != (248 & s)) throw new n("Broken UTF-8 stream"); {
                                    if (t + 3 > i) throw new n("Truncated UTF-8 stream");
                                    const r = (7 & s) << 18 | (63 & e.getUint8(t++)) << 12 | (63 & e.getUint8(t++)) << 6 | 63 & e.getUint8(t++);
                                    if (r > 1114111) throw new n("Invalid code point");
                                    a += String.fromCodePoint(r)
                                }
                            }
                        }
                ...
                getBuffer(e) {
                    this.#n(e);
                    const t = new Uint8Array(this.#e.buffer, this.#t, e);
                    return this.#t += e, t
                }
                position() {
                    return this.#t
                ...
                remaining() {
                    return this.#e.byteLength - this.#t
                }
            }
            const r = (() => {
                const e = [];
                for (let t = 0; t < 256; t++) {
                    let s = t;
                    for (let e = 0; e < 8; e++) s = 1 & s ? 3988292384 ^ s >>> 1 : s >>> 1;
                    e[t] = s
                }
                return e
            })();
            ...
            function o(e) {
                const t = Math.floor(4294967296 * Math.random()),
                    s = new Uint8Array(e.length + 8);
                return u(s, 0, t), u(s, 4, function(e) {
                    let t = 4294967295;
                    for (let s = 0; s < e.length; s++) t = t >>> 8 ^ r[255 & (t ^ e[s])];
            ...
            function c(e, t) {
                const s = function(e) {
                    let t = l(e, 2147483629) + 12820163 >>> 0;
                    return function() {
                        return t = l(t, 1664525) + 1013904223 >>> 0
                    }
                }(e);
                for (let e = 4; e < t.length; e++) t[e] = t[e] ^ s()
            }

            function u(e, t, s) {
                e[t + 0] = s >>> 24, e[t + 1] = s >>> 16, e[t + 2] = s >>> 8, e[t + 3] = s >>> 0
            }

            function l(e, t) {
                e >>>= 0, t >>>= 0;
                let s = 0;
                for (let n = 0; n < 32; n++) 1 == (t >>> n & 1) && (s += e << n);
                return s >>> 0
            }
        },
        4100(e, t, s) {
            ...
            const u = Object.freeze([107, 101, 121, 98, 114, 46, 99, 111, 109]);
            class l {
                static load(e) {
                    const t = new r.mP(e);
                    ! function(e) {
                        for (const t of u)
                            if (e.getUint8() !== t) throw new r.fL
                    }(t);
                    const s = function(e) {
                            const t = e.getUint8(),
                                s = e.getUint8(),
                                n = [];
                            for (let t = 0; t < s; t++) n.push(e.getUint16());
                            return new h(t, n)
                        }(t),
                        n = function(e, t) {
                            const s = [];
                            for (let n = 0; n < t.segments; n++) {
                                const n = [],
                                    a = e.getUint8();
                                if (a > t.size) throw new r.fL;
                                for (let s = 0; s < a; s++) {
                                    const s = e.getUint8();
                                    if (s >= t.size) throw new r.fL;
                                    const a = e.getUint8();
                                    if (0 === a) throw new r.fL;
                                    n.push({
                                        codePoint: t.codePoint(s),
                                        frequency: a
                                    })
                                }
                                s.push(n)
                    ...
                    if (t.remaining() > 0) throw new r.fL;
                    return new l(s, n)
                }
                chain;
                segments;
                constructor(e, t) {
                    if (t.length !== e.segments) throw new Error;
                    this.chain = e, this.segments = t
                }
                get order() {
                ...
                segment(e) {
                    return this.segments[this.chain.segmentIndex(e)]
                }
                compress() {
                    const e = new r.AU;
                    return function(e) {
                            for (const t of u) e.putUint8(t)
                        }(e),
                        function(e, t) {
                            e.putUint8(t.order), e.putUint8(t.size);
                            for (let s = 0; s < t.size; s++) e.putUint16(t.alphabet[s])
                        }(e, this.chain),
                        function(e, t, s) {
                            for (let n = 0; n < t.segments; n++) {
                                const a = s[n];
                                ...
                                for (const {
                                        codePoint: s,
                                        frequency: n
                                    } of a) e.putUint8(t.index(s)), e.putUint8(n)
                            }
                        }(e, this.chain, this.segments), e.buffer()
                }
                letters({
                    letterName: e
                }) {
                    const t = new Map(this.alphabet.map(e => [e, 0]));
                    for (const e of this.segments)
                        for (const {
                                codePoint: s,
                                frequency: n
                            } of e) t.set(s, (t.get(s) ?? 0) + n);
                    return [...t.entries()].map(([t, s]) => new c(t, s, e(t)))
                }
                toNgram1() {
                    const e = new o.ti(this.alphabet);
                ...
                toNgram2() {
                    const e = new o.mA(this.alphabet);
                    let t = 0;
                    for (const s of this.segments) {
                        const n = this.chain.codePoint(t);
                        for (const {
                                codePoint: t,
                                frequency: a
                            } of s) e.add(n, t, a);
                        t += 1, t === this.chain.size && (t = 0)
                    }
                    return e
                }
            }
            class h {
                ...
                offsets;
                constructor(e, t) {
                    this.order = e, this.alphabet = t, this.size = this.alphabet.length, this.segments = Math.pow(this.size, this.order - 1), this.width = Math.pow(this.size, this.order), this.offsets = function(e, t) {
                        const s = new Array(t);
                        for (let n = 0; n < t; n++) s[n] = Math.pow(e, t - n - 1);
                        return s
                ...
                segmentIndex(e) {
                    ...
                    let a = 0;
                    for (let i = 0; i < t - 1; i++) {
                        const r = e[n - t + i + 1] || 32;
                        a += this.index(r) * s[i + 1]
                    }
                    return a
                }
                entryIndex(e) {
            ...
            function v(e) {
                const t = [...(0, i.ex)(e)],
                    ...
                    n = new Array(s);
                for (let e = 0; e < s; e++) n[e] = t[(23 * e + 13) % s];
            ...
            const U = (j = [
                ...
                [o.TM.TR, []],
                [o.TM.UK, z]
            ], new Map(j.map(([e, t]) => [e, new Set(t.map(v))])));
            var j;
            var O = s(2196);
            class P {
                language;
                letters;
                constructor(e, t) {
                    this.language = e, this.letters = t
                }
                static restrict(e, t) {
                    return new class extends P {
                        constructor() {
                            super(e.language, c.restrict(e.letters, t))
                        }
                        nextWord(t, s) {
                            return e.nextWord(t, s)
                        }
                        ngram1() {
                            return e.ngram1()
                        }
            ...
            function A(e, t) {
                const s = t instanceof l ? t : l.load(t),
                    n = c.normalize(s.letters(e).filter(({
                        codePoint: e
                    }) => 32 !== e)),
                    a = new q(s);
                return new class extends P {
                    ...
                    nextWord(e, t = Math.random) {
                        return String.fromCodePoint(...((e, t) => {
                            const n = a.findPrefixes(e),
                                i = [];
                            let r = 0;
                            const o = () => r < 5 && (r++, i.length = 0, n.length > 0 && i.push(...(0, O.gl)(n, t).codePoints), !0);
                            for (o();;) {
                                const n = s.segment(i).filter(({
                                    codePoint: t
                                }) => {
                                    if (32 === t) {
                                        if (i.length < 3) return !1
                                    } else if (!e.includes(t)) return !1;
                                    return !0
                                }).map(({
                                    codePoint: e,
                                    frequency: t
                                }) => (32 === e && (t *= Math.pow(1.3, i.length)), {
                                    codePoint: e,
                                    frequency: t
                                }));
                                if (0 === n.length) {
            ...
            class V {
                ...
                matches(e) {
                    return this.codePoints.every(t => e.includes(t))
                }
            }
            class q {
                table;
                map;
                constructor(e) {
                    this.table = e, this.map = new Map(e.alphabet.map(e => [e, []]));
                    const t = e => {
                        for (const {
                                codePoint: s
                            } of this.table.segment(e))
                            if (32 !== s) {
                                e.push(s);
                                const n = new V([...e]);
                                for (const t of new Set(e)) this.map.get(s).push(n);
                                e.length < 3 && t(e), e.pop()
                            }
                    };
                    t([])
                }
                findPrefixes(e) {
                    ...
                    if (null != t) {
                        const s = this.map.get(t).filter(t => t.matches(e));
                        return s.length > 0 ? s : [new V([t])]
                    }
                    return []
                }
            }
            ...
            function x(e) {
                const {
                    ...
                    const t = U.get(e) ?? null;
                    return null != t && t.size > 0 ? new class {
                        allow(s) {
                            return !t.has(e.lowerCase(s))
                        }
                    } : new class {
                        allow(e) {
                            return !0
                ...
                return new class extends P {
                    ...
                    nextWord(t, s) {
                        for (;;) {
                            const a = e.nextWord(t, s);
                            if (n.allow(a)) return a
                        }
                    }
                    ngram1() {
                        return e.ngram1()
            ...
            const I = (0, s(7810).createContext)(null);
            class T extends P {
                static loader = async () => new T;
                static letter1 = new c(97, .1, "A");
                static letter2 = new c(98, .09, "B");
                static letter3 = new c(99, .08, "C");
                static letter4 = new c(100, .07, "D");
                static letter5 = new c(101, .06, "E");
                static letter6 = new c(102, .05, "F");
                static letter7 = new c(103, .04, "G");
                static letter8 = new c(104, .03, "H");
                static letter9 = new c(105, .02, "I");
                static letter10 = new c(106, .01, "J");
                static letters = [T.letter1, T.letter2, T.letter3, T.letter4, T.letter5, T.letter6, T.letter7, T.letter8, T.letter9, T.letter10];
                words;
                rng;
                constructor(e = ["abc", "def", "ghi"], t = (e => {
                    let t = 0;
                    const s = () => {
                        const s = t / e;
                        return t += 1, t === e && (t = 0), s
                    };
                    return s.mark = () => t, s.reset = e => {
                        t = e
                    }, s
                })(e.length)) {
                    super(o.TM.EN, T.letters), this.words = [...e], this.rng = t
                }
                nextWord(e, t = this.rng) {
                    return (0, O.gl)(this.words, t)
                }
                ngram1() {
                    const e = this.letters.map(({
                            codePoint: e
                        }) => e),
                        {
                            length: t
                ...
                ngram2() {
                    const e = this.letters.map(({
                        ...
                        s = new o.mA(e);
                    for (let n = 0; n < t; n++)
                        for (let a = 0; a < t; a++) s.set(e[n], e[a], 1);
                    return s
                }
            }
            class S {
                static empty = new S(null, null);
                codePoints;
                focusedCodePoint;
                constructor(e = null, t = null) {
                    const s = e && e.map(c.toLetter),
                        n = t && c.toLetter(t);
                    if (null != s && 0 === s.length) throw new Error;
                    if (null != s && null != n && !s.includes(n)) throw new Error;
                    this.codePoints = s && new Set(s.map(M)), this.focusedCodePoint = n && M(n)
                }
                includes(e) {
                    return null == this.codePoints || this.codePoints.has(e)
                }
            }
            const M = ({
                codePoint: e
        ...
        2044(e, t, s) {
            ...
            const n = e => {
                        ...
                        [Symbol.iterator]() {
                            ...
                            const n = {
                                ...
                                a = {
                                    ...
                                    next() {
                                        if (s < t) {
                                            const t = e.codePointAt(s) ?? 0;
                                            s += (e => e >= 65536 ? 2 : 1)(t), n.done = !1, n.value = t
                                        } else n.done = !0, n.value = -1;
                                        return n
                                    }
                                };
                            return a
                ...
                i = new Map,
                r = e => e >= 768 && e <= 879,
                o = (e, t) => a.get(t << 16 | e) ?? e;
            for (const [e, t, s] of [
                    [768, "AEINOUWYaeinouwy", "ÀÈÌǸÒÙẀỲàèìǹòùẁỳ"],
                    [769, "ACEGIKLMNOPRSUWYZacegiklmnoprsuwyzΑΕΗΙΟΥΩαεηιουω", "ÁĆÉǴÍḰĹḾŃÓṔŔŚÚẂÝŹáćéǵíḱĺḿńóṕŕśúẃýźΆΈΉΊΌΎΏάέήίόύώ"],
                    [770, "ACEGHIJOSUWYZaceghijosuwyz", "ÂĈÊĜĤÎĴÔŜÛŴŶẐâĉêĝĥîĵôŝûŵŷẑ"],
                    [771, "AEINOUVYaeinouvy", "ÃẼĨÑÕŨṼỸãẽĩñõũṽỹ"],
                    [772, "AEGIOUYaegiouy", "ĀĒḠĪŌŪȲāēḡīōūȳ"],
                    [774, "AEGIOUaegiou", "ĂĔĞĬŎŬăĕğĭŏŭ"],
                    [775, "ABCDEFGHIMNOPRSTWXYZabcdefghmnoprstwxyz", "ȦḂĊḊĖḞĠḢİṀṄȮṖṘṠṪẆẊẎŻȧḃċḋėḟġḣṁṅȯṗṙṡṫẇẋẏż"],
                    [776, "AEHIOUWXYaehiotuwxyΙΥιυ", "ÄËḦÏÖÜẄẌŸäëḧïöẗüẅẍÿΪΫϊϋ"],
                    [778, "AUauwy", "ÅŮåůẘẙ"],
                    [779, "OUou", "ŐŰőű"],
                    [780, "ACDEGHIKLNORSTUZacdeghijklnorstuz", "ǍČĎĚǦȞǏǨĽŇǑŘŠŤǓŽǎčďěǧȟǐǰǩľňǒřšťǔž"],
                    [783, "AEIORUaeioru", "ȀȄȈȌȐȔȁȅȉȍȑȕ"],
                    [807, "CDEGHKLNRSTcdeghklnrst", "ÇḐȨĢḨĶĻŅŖŞŢçḑȩģḩķļņŗşţ"],
                    [808, "AEIOUaeiou", "ĄĘĮǪŲąęįǫų"]
                ])
                for (let n = 0; n < t.length; n++) {
                    const r = t.codePointAt(n),
                        o = s.codePointAt(n);
                    a.set(e << 16 | r, o), i.set(o, r)
                }
            ...
            const h = (() => {
                    ...
                    for (const [t, s] of [
                            [
                                [65],
                                [192, 193, 194, 195, 196, 197, 256, 258, 260, 461, 478, 480, 506, 512, 514, 550, 570, 7680, 7840, 7842, 7844, 7846, 7848, 7850, 7852, 7854, 7856, 7858, 7860, 7862, 9398, 11375, 65313]
                            ],
                            [
                                [65, 65],
                                [42802]
                            ...
                            [
                                [66],
                                [385, 579, 7682, 7684, 7686, 9399, 65314]
                            ],
                            [
                                [67],
                                [67, 199, 262, 264, 266, 268, 391, 571, 7688, 9400, 42814, 65315]
                            ],
                            [
                                [68],
                                [270, 272, 393, 394, 7429, 7690, 7692, 7694, 7696, 7698, 9401, 42873, 65316]
                            ],
                            [
                                [68, 90],
                                [452, 497]
                            ...
                            [
                                [69],
                                [200, 201, 202, 203, 274, 276, 278, 280, 282, 398, 400, 516, 518, 552, 603, 7431, 7700, 7702, 7704, 7706, 7708, 7864, 7866, 7868, 7870, 7872, 7874, 7876, 7878, 9402, 65317]
                            ],
                            [
                                [70],
                                [401, 7710, 9403, 42875, 42876, 65318]
                            ],
                            [
                                [71],
                                [284, 286, 288, 290, 403, 484, 486, 500, 610, 7712, 9404, 42877, 42878, 42912, 65319]
                            ],
                            [
                                [72],
                                [292, 294, 542, 7714, 7716, 7718, 7720, 7722, 9405, 11367, 11381, 42893, 65320]
                            ],
                            [
                                [73],
                                [204, 205, 206, 207, 296, 298, 300, 302, 304, 407, 463, 520, 522, 7724, 7726, 7880, 7882, 9406, 65321]
                            ],
                            [
                                [74],
                                [308, 567, 584, 9407, 65322]
                            ],
                            [
                                [75],
                                [310, 408, 488, 7728, 7730, 7732, 9408, 11369, 42816, 42818, 42820, 42914, 65323]
                            ],
                            [
                                [76],
                                [313, 315, 317, 319, 321, 573, 7734, 7736, 7738, 7740, 9409, 11360, 11362, 42822, 42824, 42880, 65324]
                            ],
                            [
                                [76, 74],
                                [455]
                            ...
                            [
                                [77],
                                [412, 1019, 7742, 7744, 7746, 9410, 11374, 65325]
                            ],
                            [
                                [78],
                                [209, 323, 325, 327, 413, 504, 544, 7438, 7748, 7750, 7752, 7754, 9411, 42896, 42916, 65326]
                            ],
                            [
                                [78, 74],
                                [458]
                            ...
                            [
                                [79],
                                [210, 211, 212, 213, 214, 216, 332, 334, 336, 390, 415, 416, 465, 490, 492, 510, 524, 526, 554, 556, 558, 560, 7756, 7758, 7760, 7762, 7884, 7886, 7888, 7890, 7892, 7894, 7896, 7898, 7900, 7902, 7904, 7906, 9412, 42826, 42828, 65327]
                            ],
                            [
                                [79, 69],
                                [338]
                            ...
                            [
                                [80],
                                [420, 7764, 7766, 9413, 11363, 42832, 42834, 42836, 65328]
                            ],
                            [
                                [81],
                                [586, 9414, 42838, 42840, 65329]
                            ],
                            [
                                [82],
                                [340, 342, 344, 528, 530, 588, 7768, 7770, 7772, 7774, 9415, 11364, 42842, 42882, 42918, 65330]
                            ],
                            [
                                [83],
                                [346, 348, 350, 352, 536, 7776, 7778, 7780, 7782, 7784, 7838, 9416, 11390, 42884, 42920, 65331]
                            ],
                            [
                                [84],
                                [354, 356, 358, 428, 430, 538, 574, 7786, 7788, 7790, 7792, 9417, 42886, 65332]
                            ],
                            [
                                [84, 90],
                                [42792]
                            ...
                            [
                                [85],
                                [217, 218, 219, 220, 360, 362, 364, 366, 368, 370, 431, 467, 469, 471, 473, 475, 532, 534, 580, 7794, 7796, 7798, 7800, 7802, 7908, 7910, 7912, 7914, 7916, 7918, 7920, 9418, 65333]
                            ],
                            [
                                [86],
                                [434, 581, 7804, 7806, 9419, 42846, 65334]
                            ],
                            [
                                [86, 89],
                                [42848]
                            ...
                            [
                                [87],
                                [372, 7808, 7810, 7812, 7814, 7816, 9420, 11378, 65335]
                            ],
                            [
                                [88],
                                [7818, 7820, 9421, 65336]
                            ],
                            [
                                [89],
                                [221, 374, 376, 435, 562, 590, 7822, 7922, 7924, 7926, 7928, 7934, 9422, 65337]
                            ],
                            [
                                [90],
                                [377, 379, 381, 437, 548, 7824, 7826, 7828, 9423, 11371, 11391, 42850, 65338]
                            ],
                            [
                                [97],
                                [224, 225, 226, 227, 228, 229, 257, 259, 261, 462, 479, 481, 507, 513, 515, 551, 592, 593, 7681, 7834, 7841, 7843, 7845, 7847, 7849, 7851, 7853, 7855, 7857, 7859, 7861, 7863, 9424, 11365, 65345]
                            ],
                            [
                                [97, 97],
                                [42803]
                            ...
                            [
                                [98],
                                [384, 386, 387, 595, 7683, 7685, 7687, 9425, 65346]
                            ],
                            [
                                [99],
                                [231, 263, 265, 267, 269, 392, 572, 7689, 8580, 9426, 42815, 65347]
                            ],
                            [
                                [100],
                                [271, 273, 395, 396, 598, 599, 1281, 5095, 7691, 7693, 7695, 7697, 7699, 9427, 42922, 65348]
                            ],
                            [
                                [100, 104],
                                [240]
                            ...
                            [
                                [101],
                                [232, 233, 234, 235, 275, 277, 279, 281, 283, 477, 517, 519, 553, 583, 7701, 7703, 7705, 7707, 7709, 7865, 7867, 7869, 7871, 7873, 7875, 7877, 7879, 9428, 65349]
                            ],
                            [
                                [102],
                                [402, 7711, 9429, 65350]
                            ...
                            [
                                [103],
                                [285, 287, 289, 291, 485, 487, 501, 608, 7545, 7713, 9430, 42879, 42913, 65351]
                            ],
                            [
                                [104],
                                [293, 295, 543, 613, 7715, 7717, 7719, 7721, 7723, 7830, 9431, 11368, 11382, 65352]
                            ],
                            [
                                [104, 118],
                                [405]
                            ...
                            [
                                [105],
                                [236, 237, 238, 239, 297, 299, 301, 303, 305, 464, 521, 523, 616, 7725, 7727, 7881, 7883, 9432, 65353]
                            ],
                            [
                                [106],
                                [309, 496, 585, 9433, 65354]
                            ],
                            [
                                [107],
                                [311, 409, 489, 7729, 7731, 7733, 9434, 11370, 42817, 42819, 42821, 42915, 65355]
                            ],
                            [
                                [108],
                                [314, 316, 318, 320, 322, 383, 410, 619, 621, 7735, 7737, 7739, 7741, 9435, 11361, 42823, 42825, 42881, 65356]
                            ],
                            [
                                [108, 106],
                                [457]
                            ...
                            [
                                [109],
                                [623, 625, 7743, 7745, 7747, 9436, 65357]
                            ],
                            [
                                [110],
                                [241, 324, 326, 328, 329, 414, 505, 626, 1083, 1289, 7749, 7751, 7753, 7755, 9437, 42897, 42917, 65358]
                            ],
                            [
                                [110, 106],
                                [460]
                            ...
                            [
                                [111],
                                [242, 243, 244, 245, 246, 248, 333, 335, 337, 417, 466, 491, 493, 511, 525, 527, 555, 557, 559, 561, 596, 629, 7441, 7757, 7759, 7761, 7763, 7885, 7887, 7889, 7891, 7893, 7895, 7897, 7899, 7901, 7903, 7905, 7907, 9438, 42827, 42829, 65359]
                            ],
                            [
                                [111, 101],
                                [339]
                            ...
                            [
                                [112],
                                [421, 961, 7549, 7765, 7767, 9439, 42833, 42835, 42837, 65360]
                            ],
                            [
                                [113],
                                [587, 9440, 42839, 42841, 65361]
                            ],
                            [
                                [114],
                                [341, 343, 345, 529, 531, 589, 637, 7769, 7771, 7773, 7775, 9441, 42843, 42883, 42919, 65362]
                            ],
                            [
                                [115],
                                [347, 349, 351, 353, 537, 575, 642, 7777, 7779, 7781, 7783, 7785, 7835, 9442, 42885, 42921, 65363]
                            ],
                            [
                                [115, 115],
                                [223]
                            ...
                            [
                                [116],
                                [355, 357, 359, 429, 539, 648, 7787, 7789, 7791, 7793, 7831, 9443, 11366, 42887, 65364]
                            ],
                            [
                                [116, 104],
                                [254]
                            ...
                            [
                                [117],
                                [249, 250, 251, 252, 361, 363, 365, 367, 369, 371, 432, 468, 470, 472, 474, 476, 533, 535, 649, 7795, 7797, 7799, 7801, 7803, 7909, 7911, 7913, 7915, 7917, 7919, 7921, 9444, 65365]
                            ],
                            [
                                [118],
                                [651, 652, 7805, 7807, 9445, 42847, 65366]
                            ],
                            [
                                [118, 121],
                                [42849]
                            ...
                            [
                                [119],
                                [373, 7809, 7811, 7813, 7815, 7817, 7832, 9446, 11379, 65367]
                            ],
                            [
                                [120],
                                [7819, 7821, 9447, 65368]
                            ],
                            [
                                [121],
                                [253, 255, 375, 436, 563, 591, 7823, 7833, 7923, 7925, 7927, 7929, 7935, 9448, 65369]
                            ],
                            [
                                [122],
                                [378, 380, 382, 438, 549, 576, 7825, 7827, 7829, 9449, 11372, 42851, 65370]
                            ],
                            [
                                [46, 46, 46],
                                [8230]
                ...
                f = (() => {
                    ...
                    for (const [t, s] of [
                            [33, [161]],
                            [34, [171, 187, 8220, 8221, 8222, 8223, 8249, 8250]],
                            [39, [8216, 8217]],
                            [45, [8208, 8209, 8210, 8211, 8212]],
                            [63, [191]]
                        ])
                        for (const n of s) e.set(n, t);
                    return e
                ...
                d = e => e < 32,
                g = e => 10 === e || 11 === e || 12 === e || 13 === e || 8232 === e || 8233 === e,
                p = e => 9 === e || 10 === e || 11 === e || 12 === e || 13 === e || 32 === e || 160 === e || 8192 === e || 8193 === e || 8194 === e || 8195 === e || 8196 === e || 8197 === e || 8198 === e || 8199 === e || 8200 === e || 8201 === e || 8202 === e || 8232 === e || 8233 === e,
                m = (e, t) => {
                    "string" == typeof e && (e = new Intl.Locale(e));
                    const s = new Intl.Segmenter(e, {
                            granularity: "word"
                        }),
                        a = new Intl.Segmenter(e, {
                            granularity: "grapheme"
                        }),
                        i = new Intl.Collator(e),
                        r = new Map,
                        o = new Map;
                    let c = 0,
                        u = 0,
                    ...
                    const f = e => {
                            ...
                            if (null == t) {
                                t = 0;
                                for (const s of a.segment(e)) t += 1;
                                o.set(e, t)
                            }
                            return t
                        },
                        d = t => {
                            for (const {
                                    segment: a,
                                    isWordLike: i
                                } of s.segment(t.normalize()))
                                if (i) {
                                    l += 1;
                                    const t = a.toLocaleLowerCase(e);
                                    r.set(t, (r.get(t) ?? 0) + 1);
                                    const s = f(t);
                                    h += s, u += s
                                } else if (" " === a) c += 1;
                            else
                                for (const e of n(a)) p(e) ? c += 1 : u += 1
                        };
                    if (Array.isArray(t))
                    ...
                    const g = r.size,
                        m = l > 0 ? h / l : 0,
                        b = Array.from(r.entries()).map(([e, t]) => ({
                            word: e,
                            count: t
                        })).sort((e, t) => t.count - e.count || i.compare(e.word, t.word));
                    return {
                        numWhitespace: c,
                        numCharacters: u,
                        numWords: l,
...
//# sourceMappingURL=215a348db195cb9b.js.map