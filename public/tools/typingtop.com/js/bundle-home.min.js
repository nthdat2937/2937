...
//# sourceMappingURL=bootstrap.bundle.min.js.map﻿function playVideo(e, t) { t.preventDefault(); var o = $(e).parent().find("iframe"), n = o.attr("src"); n = n.replace("autoplay=0", "autoplay=1"), o.attr("src", n), $(e).parent().find("img").fadeOut(), o.fadeIn(), $(e).fadeOut() } $(".service-pack__payment-item").length && $(".service-pack__payment-item input").change((function () { $(".service-pack__box").attr("data-view", $(this).val()) })), $(".custom-select").each((function () { var e = $(this), t = e.children("option"), o = e.children("option").eq(0).text(), n = $(this).children("option").length; e.addClass("select-hidden"), e.wrap('<div class="select"></div>'), e.after('<div class="select-styled"></div>'); for (var i = e.next("div.select-styled"), s = 0; s < t.length; s++)t.eq(s).prop("selected") && (o = t.eq(s).text()); i.html("<span>" + o + "</span>"); var a = $("<ul />", { class: "select-options" }).insertAfter(i); for (s = 0; s < n; s++)$("<li />", { text: e.children("option").eq(s).text(), rel: e.children("option").eq(s).val() }).appendTo(a); var c = a.children("li"); i.click((function (e) { e.stopPropagation(), $("div.select-styled.active").not(this).each((function () { $(this).removeClass("active").next("ul.select-options").hide() })), $(this).toggleClass("active").next("ul.select-options").toggle() })), c.click((function (t) { t.stopPropagation(), i.text($(this).text()), i.html("<span>" + $(this).text() + "</span>").removeClass("active"), e.val($(this).attr("rel")).change(), a.hide() })), $(document).click((function () { i.removeClass("active"), a.hide() })) })), $((function () { const e = $("#overlay"); function t() { $(".site-header .dropdown-toggle.show").length ? e.addClass("show") : e.removeClass("show") } $(".site-header .dropdown-toggle").each((function () { $(this).on("click", (function () { t() })) })), $(document).on("click", (function () { t() })), $(".site-header .dropdown-menu").on("click", (function (e) { e.stopPropagation() })), $(".js-notification-close").on("click", (function (e) { $(".nav-notification__wrapper, .nav-notification__menu, #overlay").removeClass("show") })), $(".nav-tabs-responsive > li button").click((function () { $(".nav-tabs-responsive > li").removeClass("active"), $(this).parent().addClass("active"), $(".nav-tabs-responsive").toggleClass("open") })) })), $((function () { $(".sidebar-open").click("click", (function () { $("body, html").css("overflow", "hidden"), $("#sidebar").addClass("show") })), $(".sidebar-close").on("click", (function (e) { $("body, html").css("overflow", "visible"), $("#sidebar").removeClass("show") })), $(".navigation__button").length && $(".navigation__button").click((function () { $(this).toggleClass("opened"), $(".navigation-collapse").toggleClass("opened"), $(".navigation-collapse").css("height", $(".navigation").height()) })) })), $((function () { const e = $("#overlay"); function t() { $(".t-site-header .dropdown-toggle:not(.nav-menu-toggle).show").length ? e.addClass("show") : e.removeClass("show") } $(".t-site-header .dropdown-toggle:not(.nav-menu-toggle)").each((function () { $(this).on("click", (function () { t() })) })), $(document).on("click", (function () { t() })), $(".t-site-header .dropdown-menu").on("click", (function (e) { e.stopPropagation() })) })), $(".collapse").length > 0 && ($(".collapse").on("show.bs.collapse", (function () { $(this).parent().addClass("active") })), $(".collapse").on("hide.bs.collapse", (function () { $(this).parent().removeClass("active") }))), $((function () { $(".t-sidebar-open").click("click", (function () { $("body, html").css("overflow", "hidden"), $("#t-sidebar").addClass("show") })), $(".t-sidebar-close").on("click", (function (e) { $("body, html").css("overflow", "visible"), $("#t-sidebar").removeClass("show") })) }));
...
function activeMenuStudy(regex) {
    $("li.navigation__item").each(function(i, ui) {
        var href = $(ui).children('.navigation__item-inner').attr('href')
        if (href.match(regex)) {
...
function getListText(callback) {
    $.get('/ajax/study/get_lst_lesssons_navbar', function(res) {
        $('#dropdown-lesson-list').html(res.html)
...
function Validator(options) {
    ...
    if ($form) {
        $form.on('submit', function(e) {
            ...
            options.rules.forEach(function(rule) {
                var inputElement = $form.find(rule.selector);
                if (inputElement) {
                    var isInputValid = validate(inputElement, rule);
                    if (!isInputValid) {
                        isFormValid = false;
                    }
                }
            ...
            if (isFormValid) {
                if (typeof options.onSubmit === 'function') {
                    var enableInputs = $form.find('[name]');
                    var formValues2 = {}
                    var formValues = Array.from(enableInputs).reduce(function(values, input) {
                        formValues2[input.name] = input.value;
                        return (values[input.name] = input.value) && values;
                    }, {});
                    options.onSubmit(formValues2);
                } else {
                    $form.submit();
                }
            }
    ...
    function validate(inputElement, rule) {
        var errorElement = inputElement.parent().siblings('small.form-message');
        var errorMessage;
        var rules = selectorRules[rule.selector];
        for (var i = 0; i < rules.length; i++) {
            errorMessage = rules[i](inputElement.val(), rule);
...
Validator.isEmail = function(selector, message) {
    return {
        ...
        test: function(email) {
            ...
            return emailRgx.test(email) ? undefined : message || 'Email không hợp lệ';
        }
    }
}
Validator.minLength = function(selector, min, message) {
    return {
        selector: selector,
        test: function(value) {
            return value.trim().length >= min ? undefined : message || `Độ dài tối thiểu ${min} kí tự`;
        }
    }
}
...
Validator.maxLength = function(selector, max, message) {
    return {
        selector: selector,
        test: function(value) {
            return value.length <= max ? undefined : message || `Độ dài tối đa ${max} kí tự`;
        }
    }
}
Validator.isUsername = function(selector, message) {
    return {
        ...
        test: function(username) {
            const usernameRgx = /^[a-zA-Z0-9_]{6,14}$/;
            return usernameRgx.test(username) ? undefined : message || 'Tên đăng nhập không hợp lệ';
        }
    }
}


Validator.callback = function(selector, callback) {
    return {
        selector: selector,
        test: callback
    }
